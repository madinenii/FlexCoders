    ...
    <div className="bg-gray-50 py-20">
      <div className="lg:w-[75rem] mx-auto px-16 text-center">
        ...
        <p className="text-xl lg:text-2xl text-gray-700 mb-10 max-w-3xl mx-auto">
          Kickstart your journey with hands-on experience and guided learning.
        </p>
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          {['Dedicated onboarding & mentorship', 'Real-time projects from day one', 'Certifications & growth roadmap'].map((feature, index) => (
        ...
        <div className="mt-8">
          ...
          <p className="text-lg text-gray-600 font-mono tracking-wider">
            Trainee &rarr; Developer &rarr; Senior Developer &rarr; Team Lead
          </p>
        </div>
      </div>
    </div>
